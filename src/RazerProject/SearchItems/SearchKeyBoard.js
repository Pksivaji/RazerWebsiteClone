...
import KeyboardData from '../JsonDatas/keyboards.json';
      ...
      <div className='filterDiv'>
        ...
        <div className='Lapfilter1'>
          ...
          {KeyboardData.map((keyboard) => (
            <div key={keyboard.brand}>
              <label>
                <input
                  type='checkbox'
                  checked={selectedBrands.has(keyboard.brand)}
                  onChange={() => brandHandler(keyboard.brand)} // Use arrow function for consistent 'this'
                />
                {
                  keyboard.brand
                }
        ...
        <div className='Lapfilter2'>
          ...
          {KeyboardData.map((keyboard) => (
            <div key={keyboard.rating}>
              <label>
                <input
                  type='checkbox'
                  checked={selectedRating.has(keyboard.rating)}
                  onChange={() => ratingHandler(keyboard.rating)} // Use arrow function for consistent 'this'
                />
                {
                  keyboard.rating
                }
